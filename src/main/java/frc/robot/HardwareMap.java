...
public final class HardwareMap {
	...
	public static final int CAN_ID_SPINNER_MOTOR = 2; // Change ID, conflict with swerve
	public static final int CAN_ID_FLIP_MOTOR = 5; // Change ID, conflict with swerve
	public static final int CAN_ID_WRIST_MOTOR = 6; // Change ID, conflict with swerve
